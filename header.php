...
<div class="poklici col-4" style="max-width:350px">
<div class="media">
<svg width="3em" style="top:20px" height="3em" viewBox="0 0 16 16" class=" mr-3 bi phone-text bi-phone-vibrate" fill="white" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="media-body">
    <h6 class="mt-0 phone-text">Pokličite nas: + 386 (0)41 403 110</h6>
  </div>
</div>
</div>
...
<div class="poklici col-4" style="max-width:350px ">
<div class="media">
<svg width="3em" style="top:20px" height="3em" viewBox="0 0 16 16" class="align-self-center mr-3 bi phone-text bi-mailbox" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <div class="media-body">
    <h6 class="mt-0 phone-text">Pišite nam: info@cistilni-servis.eu</h6>
  </div>
</div>
</div>
...
<nav class="d-flex align-items-end navbar navbar-text navbar-expand-sm navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="border-top navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">O PODJETJU</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">STORITVE</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">TRGOVINA</a>
      </li>
      <li class="nav-item">
...
<hr class="rgba-white-light" style="margin: 0 10%;">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo site_url() ?>">DOMOV</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="#">O PODJETJU</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="#">STORITVE</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url('/aparati') ?>">TRGOVINA</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#">KONTAKT</a>
  </li>
