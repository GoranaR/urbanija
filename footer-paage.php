...
<div class="mt pt-5 pb-5 footer footerr">
<div class="container">
  <div class="row">
    <div class="col-lg-5 col-xs-12 about-company">
      <h2>Urbanija čistilni servis</h2>
      <p class="pr-5 text-white-50"><h4>Smo ključ do vašega čistega doma</h4>
       <br> Odlikujejo nas dolgoletne izkušnje in vrhunsko usposobljeni sodelavci s katerimi zagotavljamo hitro in kvalitetno čiščenje. Vedno in povsod!</p>
